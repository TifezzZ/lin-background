...
import { getSellData, deleteSell, addOnSale, editOnSale } from '@/api/modules/onSale'
...
async function deleteData(row) {
  ...
  await useHandleData(deleteSell, row.id, message)
  getTableList()
}
...
const openDialog = (title: string, rowData = {}) => {
  const params = {
    ...
    isView: title === '查看',
    rowData: { ...rowData },
    api: title === '新增' ? addOnSale : title === '编辑' ? editOnSale : undefined,
